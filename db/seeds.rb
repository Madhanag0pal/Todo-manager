...
u1 = User.create!(first_name: "Madhan", last_name: "N", email: "madhan@email.com", password_digest: "pass")
u2 = User.create!(first_name: "test", email: "test@email.com", password_digest: "test")
